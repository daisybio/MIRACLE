databaseChangeLog = {
	...
	changeSet(author: "mlist (generated)", id: "1340373645634-48") {
		sql(''' update slide set experimenter_id = 1 ''')  
	}
	...
	changeSet(author: "mlist (generated)", id: "1340373645634-40") {
		addNotNullConstraint(columnDataType: "bigint", columnName: "created_by_id", schemaName: "dbo", tableName: "slide", defaultNullValue: 1)
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-41") {
		addNotNullConstraint(columnDataType: "bigint", columnName: "last_updated_by_id", schemaName: "dbo", tableName: "slide", defaultNullValue: 1)
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-42") {
		addNotNullConstraint(columnDataType: "bigint", columnName: "created_by_id", schemaName: "dbo", tableName: "slide_layout", defaultNullValue: 1)
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-43") {
		addNotNullConstraint(columnDataType: "bigint", columnName: "last_updated_by_id", schemaName: "dbo", tableName: "slide_layout", defaultNullValue: 1)
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-44") {
		addNotNullConstraint(columnDataType: "datetime2", columnName: "last_updated", schemaName: "dbo", tableName: "slide", defaultNullValue: "2012-06-22 00:00:00.0000000")
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-45") {
		addNotNullConstraint(columnDataType: "datetime2", columnName: "date_created", schemaName: "dbo", tableName: "slide", defaultNullValue: "2012-06-22 00:00:00.0000000")
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-46") {
		addNotNullConstraint(columnDataType: "datetime2", columnName: "last_updated", schemaName: "dbo", tableName: "slide_layout", defaultNullValue: "2012-06-22 00:00:00.0000000")
	}
	
	changeSet(author: "mlist (generated)", id: "1340373645634-47") {
		addNotNullConstraint(columnDataType: "datetime2", columnName: "date_created", schemaName: "dbo", tableName: "slide_layout", defaultNullValue: "2012-06-22 00:00:00.0000000")
	}
}
